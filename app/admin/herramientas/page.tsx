...
export default function AdminRestaurantesPage() {
  ...
  async function cargarAdmin() {
    ...
    const requested = new URLSearchParams(window.location.search).get("restaurante");
    if (requested && modulosData.some(row => row.restaurante_id === requested)) setSeleccionado(requested);
              ...
              <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                <div className="min-w-0">
                  ...
                  <p className="mt-3 max-w-3xl text-sm font-semibold leading-relaxed !text-slate-100">
                    Configura módulos, prepara demostraciones y gestiona los recursos del restaurante.
                  </p>
                </div>
