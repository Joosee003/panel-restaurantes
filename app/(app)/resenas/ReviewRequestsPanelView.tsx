...
export default function ReviewRequestsPanelView({ restauranteId, dark, client }: { restauranteId: string; dark: boolean; client: ReviewPanelClient }) {
  ...
  return <div className="space-y-5">
    ...
    <section className={card}>
      ...
      {stats.scheduled > 0 && <p className={`mt-3 text-sm ${muted}`}>{stats.scheduled} {stats.scheduled === 1 ? "solicitud sin enviar" : "solicitudes sin enviar"}. Revisa su estado en «Todas».</p>}
